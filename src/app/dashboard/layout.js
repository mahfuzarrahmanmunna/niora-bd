...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div
      className={`flex h-screen ${darkMode ? "bg-gray-900" : "bg-gray-50"} overflow-hidden`}
    >
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 lg:w-72 xl:w-80 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 overflow-hidden ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        <div
          className={`flex flex-col h-full ${darkMode ? "bg-gray-800" : "bg-white"} shadow-xl border-r ${darkMode ? "border-gray-700" : "border-gray-200"}`}
        >
          {/* Logo */}
          <div
            className={`flex items-center h-16 px-6 ${darkMode ? "border-gray-700" : "border-gray-200"} border-b`}
          >
            <Link href="/dashboard" className="flex items-center">
              <div className="flex-shrink-0">
                <div
                  className={`w-8 h-8 rounded-lg flex items-center justify-center shadow-lg ${darkMode ? "bg-blue-600" : "bg-gradient-to-br from-blue-500 to-indigo-600"}`}
                >
                  <svg
              ...
              <span
                className={`ml-3 text-xl font-bold ${darkMode ? "text-white" : "text-gray-900"}`}
              >
                Admin Panel
              </span>
            </Link>
          ...
          {/* User Info */}
          <div
            className={`px-6 py-5 ${darkMode ? "border-gray-700" : "border-gray-200"} border-b`}
          >
          ...
          {/* BOTTOM ACTIONS */}
          <div
            className={`px-4 py-4 ${darkMode ? "border-gray-700" : "border-gray-200"} border-t mt-auto`}
          >
                ...
                >
                  {darkMode ? (
                    ...
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M20.354 15.354A9 9 0 018.646 2.646c-.08.08-.16.132-.242.132l-5.657 5.657a1.5 1.5 0 01-2.121 0l-5.657-5.657c-.09.09-.152.162-.242.242a9 9 0 00-12.708 12.708c.09.08.162.152.242.242l5.657 5.657a1.5 1.5 0 002.121 0l5.657 5.657c.09.09.152.162.242.242zM12 15.5a3.5 3.5 0 100-7 3.5 3.5 0 000 7z"
                    />
                  )}
                </svg>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      >
                        Welcome back, {session?.user?.name}. Here is what is
