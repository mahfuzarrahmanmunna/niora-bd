          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setProductData((prev) => ({ ...prev, skinType: value }))
                }
              >
                <SelectTrigger>
            ...
            <div className="grid gap-2">
              ...
              <div className="flex gap-2">
                <Select
                  ...
                  onValueChange={(value) =>
                    setProductData((prev) => ({ ...prev, material: value }))
                  }
                >
                  <SelectTrigger>
                ...
                <Button
                  ...
                  onClick={() =>
                    document
                      .getElementById("new-material-input")
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Add a new product to your inventory"
        />
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          document
                            .getElementById("new-brand-input")
                            .classList.toggle("hidden")
                        }
                      >
                        +
                    ...
                    <div
                      id="new-brand-input"
                      className="hidden flex gap-2 mt-2"
                    >
                      <Input
                        value={newBrand}
