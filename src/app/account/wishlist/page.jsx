    ...
    wishlist: [
      {
        ...
        price: 19.54,
        image: "https://picsum.photos/seed/COS025/200/200.jpg",
      },
      {
        id: "COS001",
        name: "Hydrating Face Cream",
        price: 24.99,
        image: "https://picsum.photos/seed/COS001/200/200.jpg",
      },
    ],
  });
        ...
        {user.wishlist.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Add items to your wishlist to keep track of products you like
            </p>
            <Link
              href="/allproducts"
              className="inline-block py-2 px-4 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              Browse Products
            </Link>
          </div>
