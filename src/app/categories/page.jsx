        ...
        if (data.success) {
          ...
          products.forEach((product) => {
            if (product.category && typeof product.category === "string") {
              if (categoryMap.has(product.category)) {
                ...
                if (
                  !category.sampleProducts.includes(product.name) &&
                  product.name
                ) {
          ...
          const categoriesArray = Array.from(categoryMap.values()).map(
            (category) => ({
              ...category,
              averagePrice:
                category.count > 0 ? category.totalPrice / category.count : 0,
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div
                            className={`h-10 w-10 rounded-full bg-gradient-to-r ${getCategoryColor(index)} flex items-center justify-center text-white font-bold`}
                          >
      ...
      {viewMode === "card" && selectedCategory && (
        <div className="container mx-auto px-4 py-8">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div
              className={`relative h-48 bg-gradient-to-r ${getCategoryColor(categories.findIndex((c) => c.name === selectedCategory.name))}`}
            >
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    ৳{selectedCategory.averagePrice.toFixed(2)}
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  ...
                  selectedCategory.sampleProducts.length > 0 ? (
                    selectedCategory.sampleProducts
                      .slice(0, 3)
                      .map((product, index) => (
                        <div
