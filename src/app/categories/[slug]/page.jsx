  ...
  useEffect(() => {
    if (products.length > 0 && categorySlug) {
      ...
      switch (sortBy) {
        ...
        case "price-high":
          filtered.sort(
            (a, b) => (b.finalPrice || b.price) - (a.finalPrice || b.price),
          );
          break;
        case "rating":
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="text-sm text-gray-500 mb-6 hidden sm:block">
        ...
        <Link href="/all-products" className="hover:text-gray-700">
          Products
        </Link>
        <span className="mx-2">/</span>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Discover our range of {categoryName.toLowerCase()} products
        </p>
      </div>
