    ...
    const filteredAndSortedProducts = useMemo(() => {
        ...
        switch (sortBy) {
            ...
            case 'name':
                ...
                break;
            default:
                // Keep original order or sort by ID for consistency
        ...
        return (
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="animate-pulse">
                    ...
                    <div className="bg-gray-100 p-4 rounded-lg mb-6 h-20"></div>
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-gray-700">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600">Discover our complete range of beauty and skincare products</p>
            </div>
