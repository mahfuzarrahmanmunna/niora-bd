      ...
      <div className="mt-12 border-t pt-8">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            {["description", "specifications", "ingredients", "reviews"].map(
              (tab) => (
                <button
                  key={tab}
        ...
        <div className="mt-6">
          {activeTab === "description" && (
            <div className="prose max-w-none">
              ...
              <p className="mt-4">
                ...
                results. Made with carefully selected ingredients, it provides a
                luxurious experience while being gentle on your skin.
              </p>
            </div>
          )}
          {activeTab === "specifications" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <span className="font-semibold">Shade:</span> {product.shade}
              </div>
              <div>
