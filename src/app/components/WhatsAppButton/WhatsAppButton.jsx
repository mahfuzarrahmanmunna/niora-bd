...
const WhatsAppButton = () => {
  ...
  return (
    <div
      onClick={handleClick}
      className="fixed bottom-24 md:bottom-6 right-6 z-50 bg-green-500 p-4 rounded-full shadow-lg cursor-pointer hover:bg-green-600 transition-all duration-300 hover:scale-110 animate-bounce"
