...
export default function ImageSlider() {
  ...
  const slides = [
    {
      id: 1,
      image: "https://picsum.photos/seed/slide1/1920/1080.jpg",
      link: "/products/1",
      title: "New Summer Collection",
      description: "Discover the latest trends for the sunny season.",
    },
    {
      id: 2,
      image: "https://picsum.photos/seed/slide2/1920/1080.jpg",
      link: "/products/2",
      title: "Tech Gadgets Galore",
      description: "Find the perfect gadget to upgrade your life.",
    },
    {
      id: 3,
      image: "https://picsum.photos/seed/slide3/1920/1080.jpg",
      link: "/products/3",
    ...
    {
      id: 4,
      image: "https://picsum.photos/seed/slide4/1920/1080.jpg",
      link: "/products/4",
      title: "Exclusive Member Deals",
      description: "Save big on your favorite brands. Members only!",
    },
    {
      id: 5,
      image: "https://picsum.photos/seed/slide5/1920/1080.jpg",
      link: "/products/5",
      title: "The Ultimate Outdoor Gear",
      description: "Gear up for your next adventure with us.",
    },
  ];
  ...
  return (
    ...
    <div
      className="w-full h-[250px] md:h-[500px] lg:h-[600px] rounded-2xl overflow-hidden shadow-xl"
      style={{
